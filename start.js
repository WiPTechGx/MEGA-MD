...
const targetFolderName = 'PGWIZ-MD';
const targetDir = path.join(currentDir, targetFolderName);
const repoUrl = 'https://github.com/pgwiz/PGWIZ-MD.git';
...
} else if (fs.existsSync(path.join(currentDir, 'PGWIZ-MD', 'index.js'))) {
    console.log(`✅ Found 'PGWIZ-MD/index.js'! Proceeding to start...`);
    botIndexFile = path.join(currentDir, 'PGWIZ-MD', 'index.js');
