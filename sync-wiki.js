...
const repoUrl = process.argv[2] || (fs.existsSync(path.join(__dirname, 'package.json')) && require('./package.json').name === 'pgwiz-md' ? 'https://github.com/pgwiz/PGWIZ-MD.wiki.git' : 'https://github.com/pgwiz/pgwiz-md-litrop.wiki.git');
